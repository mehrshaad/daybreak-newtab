...
// name -> { Glyph, from, to }. Gradients are app-icon style: a lighter tint at
// the top flowing into the brand colour. The glyph is a recognizable
// open-licensed mark; the tile and gradient are the Daybreak treatment.
// Anything not listed falls back to a hashed-hue monogram, so third-party
// widgets and user links always render something sensible.
export const BRANDS = {
  // common shortcuts
...
export function brandFor(name) {
  ...
  // "Google Drive" -> "drive", "mail.google.com" -> "gmail"-ish fallbacks
