// Brand marks that react-icons 5.4 does not carry. Paths are from Simple
// Icons (https://simpleicons.org), which is released under CC0-1.0 (public
// domain), so they can be bundled here. Same call signature as a react-icons
